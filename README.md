# ThaiB2B | Plan Your Travel, Online
![logo](http://thaib2b.in/assets/logo_thaib2b.png)

## About this Repository
Made with Nuxt.js, Bootstrap-Vue & powerful @nuxt/content for great experiences.
...
2. Clone your fork:
    ...
    `git clone https://github.com/<username>/Thaib2b.git`
    
    Where `<username>` is your github username.

3. Add the base repository as a remote:
    
    `git remote add upstream https://github.com/digitalPlayer1125/Thaib2b.git`
