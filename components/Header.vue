<template>
  <div class="bg-light shadow sticky-top d-flex flex-column">
                  ...
                  <ul class="list-unstyled list-inline list-social my-1 mb-md-0">
                      <li class="list-inline-item list-social-item mr-3">
                        <a aria-label="Twitter-Thaib2b" class="text-decoration-none" href="https://twitter.com/thaib2b" rel="noopener" target="_blank">
                          <svg aria-hidden="true" class="text-dark" style="height: 20px;" focusable="false" data-prefix="fab" data-icon="twitter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                      ...
                      <li class="list-inline-item list-social-item mr-3">
                          <a aria-label="Facebook-Thaib2b" class="text-decoration-none" href="https://www.facebook.com/thaib2b.in/" rel="noopener" target="_blank">
                            <svg aria-hidden="true" class="text-dark" style="height: 20px;" focusable="false" data-prefix="fab" data-icon="facebook" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                      ...
                      <li class="list-inline-item list-social-item mr-3">
                          <a aria-label="Instagram-Thaib2b" class="text-decoration-none" href="https://www.instagram.com/thaiB2B.in/" rel="noopener" target="_blank">
                            <svg aria-hidden="true" class="text-dark" style="height: 20px;" focusable="false" data-prefix="fab" data-icon="instagram" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                      ...
                      <li class="list-inline-item list-social-item">
                        <a aria-label="Instagram-Thaib2b" class="text-decoration-none" href="mailto:sales@thaiB2B.in" rel="noopener" target="_blank">
                          <svg viewBox="0 0 16 16" style="height: 20px;" fill="#fff" xmlns="http://www.w3.org/2000/svg">
